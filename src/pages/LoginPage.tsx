...
const LoginPage = ({ onLogin, onSwitchToRegister, isLoading }: LoginPageProps) => {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <p className="text-center mt-6 text-sm text-muted-foreground">
          ...
          <button onClick={onSwitchToRegister} className="text-primary hover:text-primary/80 font-medium transition-colors">
            Create one
          </button>
        </p>
      </div>
